...
<tr><td>Last Name:</td>
      <td><input type="text" name="reglname" required/></td>
</tr>
<tr><td>E-mail</td>
      <td><input type="text" name="regemail" required/></td>
</tr>
<tr><td>Username:</td>
...
<tr><td>ReEnter Password:</td>
      <td><input type="password" name="regrepassword" required/></td>
</tr>
<tr><td>Major:</td>
      <td><input type="text" name="regmajor" required/></td>
</tr>
<tr><td>Year:</td>
      <td><input type="number" name="regyear"required /></td>
</tr></tbody></table>     
