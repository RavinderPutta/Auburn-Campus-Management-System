...
<tbody>
<tr><td>First Name:</td>
      <td><input type="text" name="fregfname" required/></td>
</tr>
<tr><td>Last Name:</td>
      <td><input type="text" name="freglname" required/></td>
</tr>
<tr><td>E-mail</td>
      <td><input type="text" name="fregemail" required/></td>
</tr>
<tr><td>Username:</td>
      <td><input type="text" name="fregusername" required/></td>
</tr>
<tr><td>Password:</td>
      <td><input type="password" name="fregpassword" required/></td>
</tr>      
<tr><td>ReEnter Password:</td>
      <td><input type="password" name="fregrepassword" required/></td>
</tr>
<tr><td>Department:</td>
      <td><input type="text" name="fregdpt" required/></td>
</tr>
<tr><td>Project Details:</td>
      <td><input type="text" name="fregproject" /></td>
</tr></tbody></table>     
